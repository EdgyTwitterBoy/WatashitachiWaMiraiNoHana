...
{
    public class SlowPart : StoryboardObjectGeneratorPlus
    {
         [Configurable]
        ...
        {
            var hitobjectLayer = GetLayer("SlowPart");

            var black = hitobjectLayer.CreateSprite("sb/pixelBlack.png");

            black.ScaleVec(181500, 1920 * ScreenScale, 1080 * ScreenScale);
            black.Fade(181500, 184122, 0, 1);
            black.Fade(184122, 191991, 1, 1);
